...
// Note: resend organization invites now reuse the existing /schools
// creation flow via the Next.js API route instead of a dedicated
// backend admin endpoint, so there's no separate admin API helper here.
